...
$post_job_url    = get_theme_mod( 'post_job_url', true );
                ...
                if( jobscout_is_wp_job_manager_activated() && $count_posts->publish != 0 ){ ?>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="btn-wrap div-job-view" ><a id="btn-job-view"  href="http://localhost:8080/CMS/wordpress/jobs/" class="btn">VIEW MORE JOBS</a></div>
                        </div>
                    </div>
                <?php } 
            ?>
